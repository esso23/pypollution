...
SetVoidRecipe("purest-nitrogen-gas-pyvoid-gas", nil, "0.0")
SetVoidRecipe("bacteria-1-pyvoid-gas", nil, "0.0")
SetVoidRecipe("bacteria-1-pyvoid-fluid", nil, "0.0")
SetVoidRecipe("phytoplankton-pyvoid-gas", nil, "0.0")
SetVoidRecipe("phytoplankton-pyvoid-fluid", nil, "0.0")
SetVoidRecipe("xyhiphoe-blood-pyvoid-gas", nil, "0.0")
SetVoidRecipe("xyhiphoe-blood-pyvoid-fluid", nil, "0.0")
SetVoidRecipe("cold-air-pyvoid-gas", nil, "0.0")
SetVoidRecipe("cold-clean-air-pyvoid-gas", nil, "0.0")
SetVoidRecipe("liquid-nitrogen-pyvoid-gas", nil, "0.0")
SetVoidRecipe("liquid-nitrogen-pyvoid-fluid", nil, "0.0")
SetVoidRecipe("arthropod-blood-pyvoid-gas", nil, "0.0")
SetVoidRecipe("arthropod-blood-pyvoid-fluid", nil, "0.0")
