...
local function update_biomass_recipe(recipeName, energy, ingredientName, ingredientCount, resultName, resultCount)
	...
	if energy then
		...
		log("Modified " .. recipeName .. " energy required to " .. energy)
	end
	...
	if ingredientCount and ingredientName then
		for _,v in pairs(recipe.ingredients) do
			if (v.name == ingredientName) then
				...
				log("Modified " .. recipeName .. " ingredient count to " .. ingredientCount)
			end
		end
	end
	...
	if resultCount and resultName then
		for _,v in pairs(recipe.results) do
			if (v.name == resultName) then
				...
				log("Modified " .. recipeName .. " result count to " .. resultCount)
			end
		end
	end
end
...
-- Biomass recipes
if mods["pyalienlife"] then
	update_biomass_recipe("biomass-ralesia", nil, "ralesias", nil, "biomass", nil) -- 3 ralesias 10 20
	...
	update_biomass_recipe("biomass-rennea-seeds", nil, "rennea-seeds", nil, "biomass", nil) -- 3 rennea-seeds 10 45
	update_biomass_recipe("biomass-yotoi-fruit", nil, "yotoi-fruit", nil, "biomass", nil) -- 3 yotoi-fruit 1 3
	update_biomass_recipe("biomass-yotoi-leaves", nil, "yotoi-leaves", nil, "biomass", nil) -- 3 yotoi-leaves 1 2
	update_biomass_recipe("biomass-yotoi-seeds", nil, "yotoi-seeds", nil, "biomass", nil) -- 3 yotoi-seeds 10 10
	update_biomass_recipe("biomass-tuuphra-seeds", nil, "tuuphra-seeds", nil, "biomass", nil) -- 3 tuuphra-seeds 10 15
	...
	update_biomass_recipe("biomass-kicalk-seeds", nil, "kicalk-seeds", nil, "biomass", nil) -- 3 kicalk-seeds 10 280
	update_biomass_recipe("biomass-kicalk-seeds-mk02", nil, "kicalk-seeds-mk02", nil, "biomass", nil) -- 3 kicalk-seeds-mk02 10 300
	update_biomass_recipe("biomass-kicalk-seeds-mk03", nil, "kicalk-seeds-mk03", nil, "biomass", nil) -- 3 kicalk-seeds-mk03 10 320
	update_biomass_recipe("biomass-kicalk-seeds-mk04", nil, "kicalk-seeds-mk04", nil, "biomass", nil) -- 3 kicalk-seeds-mk04 10 340
	update_biomass_recipe("biomass-cadaveric-arum-seeds", nil, "cadaveric-arum-seeds", nil, "biomass", nil) -- 3 cadaveric-arum-seeds 10 25
	update_biomass_recipe("biomass-moondrop-seeds", nil, "moondrop-seeds", nil, "biomass", nil) -- 3 moondrop-seeds 5 12
	...
	update_biomass_recipe("biomass-cadaveric-arum", nil, "cadaveric-arum", nil, "biomass", nil) -- 3 cadaveric-arum 1 5
	...
	update_biomass_recipe("biomass-rennea", nil, "rennea", nil, "biomass", nil) -- 3 rennea 5 10
	...
	update_biomass_recipe("biomass-kicalk", nil, "kicalk", nil, "biomass", nil) -- 3 kicalk 4 280
	...
	update_biomass_recipe("biomass-phytoplankton", nil, "phytoplankton", nil, "biomass", nil) -- 3 phytoplankton 50 45
	update_biomass_recipe("biomass-moondrop", nil, "moondrop", nil, "biomass", nil) -- 3 moondrop 5 35
	...
	update_biomass_recipe("biomass-fawogae", nil, "fawogae", nil, "biomass", nil) -- 3 fawogae 20 60
	...
	update_biomass_recipe("biomass-cocoon", nil, "cocoon", nil, "biomass", nil) -- 3 cocoon 1 1
	update_biomass_recipe("biomass-bonemeal", nil, "bonemeal", nil, "biomass", nil) -- 3 bonemeal 1 3
	update_biomass_recipe("biomass-bones", nil, "bones", nil, "biomass", nil) -- 3 bones 1 3
	update_biomass_recipe("biomass-brain", nil, "brain", nil, "biomass", nil) -- 3 brain 1 3
	update_biomass_recipe("biomass-carapace", nil, "carapace", nil, "biomass", nil) -- 3 carapace 1 5
	...
	update_biomass_recipe("biomass-fawogae-substrate", nil, "fawogae-substrate", nil, "biomass", nil) -- 3 fawogae-substrate 1 5
	update_biomass_recipe("biomass-fungal-substrate", nil, "fungal-substrate", nil, "biomass", nil) -- 3 fungal-substrate 1 4
	update_biomass_recipe("biomass-fungal-substrate-02", nil, "fungal-substrate-02", nil, "biomass", nil) -- 3 fungal-substrate-02 1 5
	update_biomass_recipe("biomass-fungal-substrate-03", nil, "fungal-substrate-03", nil, "biomass", nil) -- 3 fungal-substrate-03 1 6
	update_biomass_recipe("biomass-guts", nil, "guts", nil, "biomass", nil) -- 3 guts 1 3
	...
	update_biomass_recipe("biomass-mukmoux-fat", nil, "mukmoux-fat", nil, "biomass", nil) -- 3 mukmoux-fat 1 3
	...
	update_biomass_recipe("biomass-agar", nil, "agar", nil, "biomass", nil) -- 3 agar 1 3
	...
	update_biomass_recipe("biomass-fertilizer", nil, "fertilizer", nil, "biomass", nil) -- 3 fertilizer 1 15
	...
	update_biomass_recipe("biomass-fish-egg", nil, "fish-egg", nil, "biomass", nil) -- 3 fish-egg 1 4
	update_biomass_recipe("biomass-sea-sponge-sprouts", nil, "sea-sponge-sprouts", nil, "biomass", nil) -- 3 sea-sponge-sprouts 1 10
	update_biomass_recipe("biomass-blood-caged-ulric", nil, "blood-caged-ulric", nil, "biomass", nil) -- 3 blood-caged-ulric 1 20
	update_biomass_recipe("biomass-bone-caged-ulric", nil, "bone-caged-ulric", nil, "biomass", nil) -- 3 bone-caged-ulric 1 20
	update_biomass_recipe("biomass-brain-caged-ulric", nil, "brain-caged-ulric", nil, "biomass", nil) -- 3 brain-caged-ulric 1 20
	update_biomass_recipe("biomass-fat-caged-ulric", nil, "fat-caged-ulric", nil, "biomass", nil) -- 3 fat-caged-ulric 1 20
	update_biomass_recipe("biomass-guts-caged-ulric", nil, "guts-caged-ulric", nil, "biomass", nil) -- 3 guts-caged-ulric 1 20
	update_biomass_recipe("biomass-meat-caged-ulric", nil, "meat-caged-ulric", nil, "biomass", nil) -- 3 meat-caged-ulric 1 20
	update_biomass_recipe("biomass-skin-caged-ulric", nil, "skin-caged-ulric", nil, "biomass", nil) -- 3 skin-caged-ulric 1 20
	update_biomass_recipe("biomass-blood-caged-auog", nil, "blood-caged-auog", nil, "biomass", nil) -- 3 blood-caged-auog 1 30
	update_biomass_recipe("biomass-bone-caged-auog", nil, "bone-caged-auog", nil, "biomass", nil) -- 3 bone-caged-auog 1 30
	update_biomass_recipe("biomass-brain-caged-auog", nil, "brain-caged-auog", nil, "biomass", nil) -- 3 brain-caged-auog 1 30
	update_biomass_recipe("biomass-fat-caged-auog", nil, "fat-caged-auog", nil, "biomass", nil) -- 3 fat-caged-auog 1 30
	update_biomass_recipe("biomass-guts-caged-auog", nil, "guts-caged-auog", nil, "biomass", nil) -- 3 guts-caged-auog 1 30
	update_biomass_recipe("biomass-meat-caged-auog", nil, "meat-caged-auog", nil, "biomass", nil) -- 3 meat-caged-auog 1 30
	update_biomass_recipe("biomass-skin-caged-auog", nil, "skin-caged-auog", nil, "biomass", nil) -- 3 skin-caged-auog 1 30
	update_biomass_recipe("biomass-caged-auog", nil, "caged-auog", nil, "biomass", nil) -- 3 caged-auog 1 20
	update_biomass_recipe("biomass-urea", nil, "urea", nil, "biomass", nil) -- 3 urea 1 1
	update_biomass_recipe("biomass-auog-pup", nil, "auog-pup", nil, "biomass", nil) -- 3 auog-pup 1 15
	update_biomass_recipe("biomass-blood-caged-mukmoux", nil, "blood-caged-mukmoux", nil, "biomass", nil) -- 3 blood-caged-mukmoux 1 25
	update_biomass_recipe("biomass-bone-caged-mukmoux", nil, "bone-caged-mukmoux", nil, "biomass", nil) -- 3 bone-caged-mukmoux 1 25
	update_biomass_recipe("biomass-brain-caged-mukmoux", nil, "brain-caged-mukmoux", nil, "biomass", nil) -- 3 brain-caged-mukmoux 1 25
	update_biomass_recipe("biomass-fat-caged-mukmoux", nil, "fat-caged-mukmoux", nil, "biomass", nil) -- 3 fat-caged-mukmoux 1 25
	update_biomass_recipe("biomass-guts-caged-mukmoux", nil, "guts-caged-mukmoux", nil, "biomass", nil) -- 3 guts-caged-mukmoux 1 25
	update_biomass_recipe("biomass-meat-caged-mukmoux", nil, "meat-caged-mukmoux", nil, "biomass", nil) -- 3 meat-caged-mukmoux 1 25
	update_biomass_recipe("biomass-skin-caged-mukmoux", nil, "skin-caged-mukmoux", nil, "biomass", nil) -- 3 skin-caged-mukmoux 1 25
	update_biomass_recipe("biomass-caged-mukmoux", nil, "caged-mukmoux", nil, "biomass", nil) -- 3 caged-mukmoux 1 20
	update_biomass_recipe("biomass-mukmoux-calf", nil, "mukmoux-calf", nil, "biomass", nil) -- 3 mukmoux-calf 1 10
	update_biomass_recipe("biomass-blood-caged-vrauks", nil, "blood-caged-vrauks", nil, "biomass", nil) -- 3 blood-caged-vrauks 1 20
	update_biomass_recipe("biomass-brain-caged-vrauks", nil, "brain-caged-vrauks", nil, "biomass", nil) -- 3 brain-caged-vrauks 1 20
	update_biomass_recipe("biomass-caged-vrauks", nil, "caged-vrauks", nil, "biomass", nil) -- 3 caged-vrauks 1 20
	update_biomass_recipe("biomass-chitin-caged-vrauks", nil, "chitin-caged-vrauks", nil, "biomass", nil) -- 3 chitin-caged-vrauks 1 20
	update_biomass_recipe("biomass-guts-caged-vrauks", nil, "guts-caged-vrauks", nil, "biomass", nil) -- 3 guts-caged-vrauks 1 20
	update_biomass_recipe("biomass-meat-caged-vrauks", nil, "meat-caged-vrauks", nil, "biomass", nil) -- 3 meat-caged-vrauks 1 20
	update_biomass_recipe("biomass-blood-caged-arthurian", nil, "blood-caged-arthurian", nil, "biomass", nil) -- 3 blood-caged-arthurian 1 20
	update_biomass_recipe("biomass-bone-caged-arthurian", nil, "bone-caged-arthurian", nil, "biomass", nil) -- 3 bone-caged-arthurian 1 20
	update_biomass_recipe("biomass-brain-caged-arthurian", nil, "brain-caged-arthurian", nil, "biomass", nil) -- 3 brain-caged-arthurian 1 20
	update_biomass_recipe("biomass-fat-caged-arthurian", nil, "fat-caged-arthurian", nil, "biomass", nil) -- 3 fat-caged-arthurian 1 20
	update_biomass_recipe("biomass-guts-caged-arthurian", nil, "guts-caged-arthurian", nil, "biomass", nil) -- 3 guts-caged-arthurian 1 20
	update_biomass_recipe("biomass-meat-caged-arthurian", nil, "meat-caged-arthurian", nil, "biomass", nil) -- 3 meat-caged-arthurian 1 20
	update_biomass_recipe("biomass-skin-caged-arthurian", nil, "skin-caged-arthurian", nil, "biomass", nil) -- 3 skin-caged-arthurian 1 20
	update_biomass_recipe("biomass-caged-arthurian", nil, "caged-arthurian", nil, "biomass", nil) -- 3 caged-arthurian 1 20
	update_biomass_recipe("biomass-arthurian-egg", nil, "arthurian-egg", nil, "biomass", nil) -- 3 arthurian-egg 1 5
	update_biomass_recipe("biomass-arthurian-pup", nil, "arthurian-pup", nil, "biomass", nil) -- 3 arthurian-pup 1 10
	update_biomass_recipe("biomass-blood-dhilmos", nil, "blood-dhilmos", nil, "biomass", nil) -- 3 blood-dhilmos 1 20
	update_biomass_recipe("biomass-fat-dhilmos", nil, "fat-dhilmos", nil, "biomass", nil) -- 3 fat-dhilmos 1 20
	update_biomass_recipe("biomass-guts-dhilmos", nil, "guts-dhilmos", nil, "biomass", nil) -- 3 guts-dhilmos 1 20
	update_biomass_recipe("biomass-meat-dhilmos", nil, "meat-dhilmos", nil, "biomass", nil) -- 3 meat-dhilmos 1 20
	update_biomass_recipe("biomass-dhilmos-pup", nil, "dhilmos-pup", nil, "biomass", nil) -- 3 dhilmos-pup 1 10
	update_biomass_recipe("biomass-dhilmos-egg", nil, "dhilmos-egg", nil, "biomass", nil) -- 3 dhilmos-egg 1 5
	update_biomass_recipe("biomass-blood-caged-scrondrix", nil, "blood-caged-scrondrix", nil, "biomass", nil) -- 3 blood-caged-scrondrix 1 25
	update_biomass_recipe("biomass-bone-caged-scrondrix", nil, "bone-caged-scrondrix", nil, "biomass", nil) -- 3 bone-caged-scrondrix 1 25
	update_biomass_recipe("biomass-brain-caged-scrondrix", nil, "brain-caged-scrondrix", nil, "biomass", nil) -- 3 brain-caged-scrondrix 1 25
	update_biomass_recipe("biomass-fat-caged-scrondrix", nil, "fat-caged-scrondrix", nil, "biomass", nil) -- 3 fat-caged-scrondrix 1 25
	update_biomass_recipe("biomass-guts-caged-scrondrix", nil, "guts-caged-scrondrix", nil, "biomass", nil) -- 3 guts-caged-scrondrix 1 25
	update_biomass_recipe("biomass-meat-caged-scrondrix", nil, "meat-caged-scrondrix", nil, "biomass", nil) -- 3 meat-caged-scrondrix 1 25
	update_biomass_recipe("biomass-skin-caged-scrondrix", nil, "skin-caged-scrondrix", nil, "biomass", nil) -- 3 skin-caged-scrondrix 1 25
	update_biomass_recipe("biomass-caged-scrondrix", nil, "caged-scrondrix", nil, "biomass", nil) -- 3 caged-scrondrix 1 25
	...
	update_biomass_recipe("biomass-blood-caged-phadai", nil, "blood-caged-phadai", nil, "biomass", nil) -- 3 blood-caged-phadai 1 20
	update_biomass_recipe("biomass-bone-caged-phadai", nil, "bone-caged-phadai", nil, "biomass", nil) -- 3 bone-caged-phadai 1 20
	update_biomass_recipe("biomass-brain-caged-phadai", nil, "brain-caged-phadai", nil, "biomass", nil) -- 3 brain-caged-phadai 1 20
	update_biomass_recipe("biomass-fat-caged-phadai", nil, "fat-caged-phadai", nil, "biomass", nil) -- 3 fat-caged-phadai 1 20
	update_biomass_recipe("biomass-guts-caged-phadai", nil, "guts-caged-phadai", nil, "biomass", nil) -- 3 guts-caged-phadai 1 20
	update_biomass_recipe("biomass-meat-caged-phadai", nil, "meat-caged-phadai", nil, "biomass", nil) -- 3 meat-caged-phadai 1 20
	update_biomass_recipe("biomass-skin-caged-phadai", nil, "skin-caged-phadai", nil, "biomass", nil) -- 3 skin-caged-phadai 1 20
	update_biomass_recipe("biomass-caged-phadai", nil, "caged-phadai", nil, "biomass", nil) -- 3 caged-phadai 1 20
	update_biomass_recipe("biomass-phadai-pup", nil, "phadai-pup", nil, "biomass", nil) -- 3 phadai-pup 1 15
	update_biomass_recipe("biomass-blood-caged-dingrits", nil, "blood-caged-dingrits", nil, "biomass", nil) -- 3 blood-caged-dingrits 1 15
	update_biomass_recipe("biomass-bone-caged-dingrits", nil, "bone-caged-dingrits", nil, "biomass", nil) -- 3 bone-caged-dingrits 1 15
	update_biomass_recipe("biomass-brain-caged-dingrits", nil, "brain-caged-dingrits", nil, "biomass", nil) -- 3 brain-caged-dingrits 1 15
	update_biomass_recipe("biomass-fat-caged-dingrits", nil, "fat-caged-dingrits", nil, "biomass", nil) -- 3 fat-caged-dingrits 1 15
	update_biomass_recipe("biomass-guts-caged-dingrits", nil, "guts-caged-dingrits", nil, "biomass", nil) -- 3 guts-caged-dingrits 1 15
	update_biomass_recipe("biomass-meat-caged-dingrits", nil, "meat-caged-dingrits", nil, "biomass", nil) -- 3 meat-caged-dingrits 1 15
	update_biomass_recipe("biomass-caged-dingrits", nil, "caged-dingrits", nil, "biomass", nil) -- 3 caged-dingrits 1 15
	update_biomass_recipe("biomass-charged-dingrit", nil, "charged-dingrit", nil, "biomass", nil) -- 3 charged-dingrit 1 20
	update_biomass_recipe("biomass-dingrits-cub", nil, "dingrits-cub", nil, "biomass", nil) -- 3 dingrits-cub 1 10
	...
	update_biomass_recipe("biomass-blood-caged-kmauts", nil, "blood-caged-kmauts", nil, "biomass", nil) -- 3 blood-caged-kmauts 1 20
	update_biomass_recipe("biomass-brain-caged-kmauts", nil, "brain-caged-kmauts", nil, "biomass", nil) -- 3 brain-caged-kmauts 1 20
	update_biomass_recipe("biomass-fat-caged-kmauts", nil, "fat-caged-kmauts", nil, "biomass", nil) -- 3 fat-caged-kmauts 1 20
	update_biomass_recipe("biomass-guts-caged-kmauts", nil, "guts-caged-kmauts", nil, "biomass", nil) -- 3 guts-caged-kmauts 1 20
	update_biomass_recipe("biomass-meat-caged-kmauts", nil, "meat-caged-kmauts", nil, "biomass", nil) -- 3 meat-caged-kmauts 1 20
	update_biomass_recipe("biomass-caged-kmauts", nil, "caged-kmauts", nil, "biomass", nil) -- 3 caged-kmauts 1 20
	update_biomass_recipe("biomass-kmauts-cub", nil, "kmauts-cub", nil, "biomass", nil) -- 3 kmauts-cub 1 10
	update_biomass_recipe("biomass-serine", nil, "serine", nil, "biomass", nil) -- 3 serine 1 5
	update_biomass_recipe("biomass-tendon", nil, "tendon", nil, "biomass", nil) -- 3 tendon 1 5
	update_biomass_recipe("biomass-blood-vonix", nil, "blood-vonix", nil, "biomass", nil) -- 3 blood-vonix 1 30
	update_biomass_recipe("biomass-brain-vonix", nil, "brain-vonix", nil, "biomass", nil) -- 3 brain-vonix 1 30
	update_biomass_recipe("biomass-fat-vonix", nil, "fat-vonix", nil, "biomass", nil) -- 3 fat-vonix 1 30
	update_biomass_recipe("biomass-guts-vonix", nil, "guts-vonix", nil, "biomass", nil) -- 3 guts-vonix 1 30
	update_biomass_recipe("biomass-meat-vonix", nil, "meat-vonix", nil, "biomass", nil) -- 3 meat-vonix 1 30
	update_biomass_recipe("biomass-skin-vonix", nil, "skin-vonix", nil, "biomass", nil) -- 3 skin-vonix 1 30
	update_biomass_recipe("biomass-venon-gland", nil, "venon-gland", nil, "biomass", nil) -- 3 venon-gland 1 2
	update_biomass_recipe("biomass-vonix-cub", nil, "vonix-cub", nil, "biomass", nil) -- 3 vonix-cub 1 15
	update_biomass_recipe("biomass-vonix-eggs", nil, "vonix-eggs", nil, "biomass", nil) -- 3 vonix-eggs 1 5
	update_biomass_recipe("biomass-blood-caged-phagnot", nil, "blood-caged-phagnot", nil, "biomass", nil) -- 3 blood-caged-phagnot 1 15
	update_biomass_recipe("biomass-bone-caged-phagnot", nil, "bone-caged-phagnot", nil, "biomass", nil) -- 3 bone-caged-phagnot 1 15
	update_biomass_recipe("biomass-brain-caged-phagnot", nil, "brain-caged-phagnot", nil, "biomass", nil) -- 3 brain-caged-phagnot 1 15
	update_biomass_recipe("biomass-guts-caged-phagnot", nil, "guts-caged-phagnot", nil, "biomass", nil) -- 3 guts-caged-phagnot 1 15
	update_biomass_recipe("biomass-meat-caged-phagnot", nil, "meat-caged-phagnot", nil, "biomass", nil) -- 3 meat-caged-phagnot 1 15
	update_biomass_recipe("biomass-skin-caged-phagnot", nil, "skin-caged-phagnot", nil, "biomass", nil) -- 3 skin-caged-phagnot 1 15
	update_biomass_recipe("biomass-caged-phagnot", nil, "caged-phagnot", nil, "biomass", nil) -- 3 caged-phagnot 1 15
	...
	update_biomass_recipe("biomass-bone-xeno", nil, "bone-xeno", nil, "biomass", nil) -- 3 bone-xeno 1 20
	update_biomass_recipe("biomass-brain-xeno", nil, "brain-xeno", nil, "biomass", nil) -- 3 brain-xeno 1 20
	update_biomass_recipe("biomass-chitin-xeno", nil, "chitin-xeno", nil, "biomass", nil) -- 3 chitin-xeno 1 20
	update_biomass_recipe("biomass-meat-xeno", nil, "meat-xeno", nil, "biomass", nil) -- 3 meat-xeno 1 20
	update_biomass_recipe("biomass-sulfuric-xeno", nil, "sulfuric-xeno", nil, "biomass", nil) -- 3 sulfuric-xeno 1 20
	update_biomass_recipe("biomass-xeno-egg", nil, "xeno-egg", nil, "biomass", nil) -- 3 xeno-egg 1 5
	update_biomass_recipe("biomass-guts-arqad", nil, "guts-arqad", nil, "biomass", nil) -- 3 guts-arqad 1 5
	update_biomass_recipe("biomass-chitin-arqad", nil, "chitin-arqad", nil, "biomass", nil) -- 3 chitin-arqad 1 5
	update_biomass_recipe("biomass-meat-arqad", nil, "meat-arqad", nil, "biomass", nil) -- 3 meat-arqad 1 5
	update_biomass_recipe("biomass-blood-arqad", nil, "blood-arqad", nil, "biomass", nil) -- 3 blood-arqad 1 5
	update_biomass_recipe("biomass-arqad-egg", nil, "arqad-egg", nil, "biomass", nil) -- 3 arqad-egg 1 5
	update_biomass_recipe("biomass-arqad-maggot", nil, "arqad-maggot", nil, "biomass", nil) -- 3 arqad-maggot 1 5
	update_biomass_recipe("biomass-blood-zipir", nil, "blood-zipir", nil, "biomass", nil) -- 3 blood-zipir 1 25
	update_biomass_recipe("biomass-brain-zipir", nil, "brain-zipir", nil, "biomass", nil) -- 3 brain-zipir 1 25
	update_biomass_recipe("biomass-fat-zipir", nil, "fat-zipir", nil, "biomass", nil) -- 3 fat-zipir 1 25
	update_biomass_recipe("biomass-guts-zipir", nil, "guts-zipir", nil, "biomass", nil) -- 3 guts-zipir 1 25
	update_biomass_recipe("biomass-meat-zipir", nil, "meat-zipir", nil, "biomass", nil) -- 3 meat-zipir 1 25
	update_biomass_recipe("biomass-skin-zipir", nil, "skin-zipir", nil, "biomass", nil) -- 3 skin-zipir 1 25
	update_biomass_recipe("biomass-zipir-eggs", nil, "zipir-eggs", nil, "biomass", nil) -- 3 zipir-eggs 1 5
	update_biomass_recipe("biomass-zipir-pup", nil, "zipir-pup", nil, "biomass", nil) -- 3 zipir-pup 1 10
	update_biomass_recipe("biomass-blood-trits", nil, "blood-trits", nil, "biomass", nil) -- 3 blood-trits 1 35
	update_biomass_recipe("biomass-brain-trits", nil, "brain-trits", nil, "biomass", nil) -- 3 brain-trits 1 35
	update_biomass_recipe("biomass-fat-trits", nil, "fat-trits", nil, "biomass", nil) -- 3 fat-trits 1 35
	update_biomass_recipe("biomass-guts-trits", nil, "guts-trits", nil, "biomass", nil) -- 3 guts-trits 1 35
	update_biomass_recipe("biomass-meat-trits", nil, "meat-trits", nil, "biomass", nil) -- 3 meat-trits 1 35
	update_biomass_recipe("biomass-skin-trits", nil, "skin-trits", nil, "biomass", nil) -- 3 skin-trits 1 35
	update_biomass_recipe("biomass-bone-trits", nil, "bone-trits", nil, "biomass", nil) -- 3 bone-trits 1 35
	update_biomass_recipe("biomass-trits-pup", nil, "trits-pup", nil, "biomass", nil) -- 3 trits-pup 1 20
	update_biomass_recipe("biomass-photophore", nil, "photophore", nil, "biomass", nil) -- 3 photophore 1 5
	update_biomass_recipe("biomass-blood-xyhiphoe", nil, "blood-xyhiphoe", nil, "biomass", nil) -- 3 blood-xyhiphoe 1 10
	update_biomass_recipe("biomass-meat-xyhiphoe", nil, "meat-xyhiphoe", nil, "biomass", nil) -- 3 meat-xyhiphoe 1 10
	update_biomass_recipe("biomass-guts-xyhiphoe", nil, "guts-xyhiphoe", nil, "biomass", nil) -- 3 guts-xyhiphoe 1 10
	update_biomass_recipe("biomass-shell-xyhiphoe", nil, "shell-xyhiphoe", nil, "biomass", nil) -- 3 shell-xyhiphoe 1 10
	update_biomass_recipe("biomass-shell", nil, "shell", nil, "biomass", nil) -- 3 shell 1 1
	update_biomass_recipe("biomass-xyhiphoe-cub", nil, "xyhiphoe-cub", nil, "biomass", nil) -- 3 xyhiphoe-cub 1 1
	update_biomass_recipe("biomass-blood-caged-korlex", nil, "blood-caged-korlex", nil, "biomass", nil) -- 3 blood-caged-korlex 1 10
	update_biomass_recipe("biomass-bone-caged-korlex", nil, "bone-caged-korlex", nil, "biomass", nil) -- 3 bone-caged-korlex 1 10
	update_biomass_recipe("biomass-brain-caged-korlex", nil, "brain-caged-korlex", nil, "biomass", nil) -- 3 brain-caged-korlex 1 10
	update_biomass_recipe("biomass-fat-caged-korlex", nil, "fat-caged-korlex", nil, "biomass", nil) -- 3 fat-caged-korlex 1 10
	update_biomass_recipe("biomass-guts-caged-korlex", nil, "guts-caged-korlex", nil, "biomass", nil) -- 3 guts-caged-korlex 1 10
	update_biomass_recipe("biomass-meat-caged-korlex", nil, "meat-caged-korlex", nil, "biomass", nil) -- 3 meat-caged-korlex 1 10
	update_biomass_recipe("biomass-skin-caged-korlex", nil, "skin-caged-korlex", nil, "biomass", nil) -- 3 skin-caged-korlex 1 10
	update_biomass_recipe("biomass-caged-korlex", nil, "caged-korlex", nil, "biomass", nil) -- 3 caged-korlex 1 10
	update_biomass_recipe("biomass-korlex-pup", nil, "korlex-pup", nil, "biomass", nil) -- 3 korlex-pup 1 5
	...
	update_biomass_recipe("biomass-auog", nil, "auog", nil, "biomass", nil) -- 3 auog 1 20
	...
	update_biomass_recipe("biomass-cridren", nil, "cridren", nil, "biomass", nil) -- 3 cridren 1 40
	update_biomass_recipe("biomass-arthurian", nil, "arthurian", nil, "biomass", nil) -- 3 arthurian 1 10
	...
	update_biomass_recipe("biomass-bhoddos", nil, "bhoddos", nil, "biomass", nil) -- 3 bhoddos 1 5
	...
	update_biomass_recipe("biomass-dingrits", nil, "dingrits", nil, "biomass", nil) -- 3 dingrits 1 20
	...
	update_biomass_recipe("biomass-dhilmos", nil, "dhilmos", nil, "biomass", nil) -- 3 dhilmos 1 15
	...
	update_biomass_recipe("biomass-fish", nil, "fish", nil, "biomass", nil) -- 3 fish 1 5
	...
	update_biomass_recipe("biomass-kmauts", nil, "kmauts", nil, "biomass", nil) -- 3 kmauts 1 10
	...
	update_biomass_recipe("biomass-korlex", nil, "korlex", nil, "biomass", nil) -- 3 korlex 1 10
	...
	update_biomass_recipe("biomass-navens", nil, "navens", nil, "biomass", nil) -- 3 navens 1 10
	...
	update_biomass_recipe("biomass-phagnot", nil, "phagnot", nil, "biomass", nil) -- 3 phagnot 1 12
	...
	update_biomass_recipe("biomass-phadai", nil, "phadai", nil, "biomass", nil) -- 3 phadai 1 10
	...
	update_biomass_recipe("biomass-sea-sponge", nil, "sea-sponge", nil, "biomass", nil) -- 3 sea-sponge 1 5
	...
	update_biomass_recipe("biomass-scrondrix", nil, "scrondrix", nil, "biomass", nil) -- 3 scrondrix 1 20
	...
	update_biomass_recipe("biomass-tuuphra", nil, "tuuphra", nil, "biomass", nil) -- 3 tuuphra 1 5
	...
	update_biomass_recipe("biomass-ulric", nil, "ulric", nil, "biomass", nil) -- 3 ulric 1 8
	...
	update_biomass_recipe("biomass-vonix", nil, "vonix", nil, "biomass", nil) -- 3 vonix 1 40
	...
	update_biomass_recipe("biomass-vrauks", nil, "vrauks", nil, "biomass", nil) -- 3 vrauks 1 8
	...
	update_biomass_recipe("biomass-xyhiphoe", nil, "xyhiphoe", nil, "biomass", nil) -- 3 xyhiphoe 1 10
	...
	update_biomass_recipe("biomass-xeno", nil, "xeno", nil, "biomass", nil) -- 3 xeno 1 10
	...
	update_biomass_recipe("biomass-arqad", nil, "arqad", nil, "biomass", nil) -- 3 arqad 1 10
	...
	update_biomass_recipe("biomass-yotoi", nil, "yotoi", nil, "biomass", nil) -- 3 yotoi 1 15
	...
	update_biomass_recipe("biomass-yaedols", nil, "yaedols", nil, "biomass", nil) -- 3 yaedols 1 10
	...
	update_biomass_recipe("biomass-zipir1", nil, "zipir1", nil, "biomass", nil) -- 3 zipir1 1 20
	...
	update_biomass_recipe("biomass-glycerol", nil, "glycerol", 10, "biomass", 1) -- 3 glycerol 10 10
	update_biomass_recipe("biomass-oleochemicals", nil, "oleochemicals", nil, "biomass", nil) -- 3 oleochemicals 10 10
	update_biomass_recipe("biomass-xyhiphoe-blood", nil, "arthropod-blood", nil, "biomass", nil) -- 3 arthropod-blood 10 10
	update_biomass_recipe("biomass-a-molasse", nil, "a-molasse", nil, "biomass", nil) -- 3 a-molasse 30 12
	update_biomass_recipe("biomass-arthropod-blood", nil, "arthropod-blood", nil, "biomass", nil) -- 3 arthropod-blood 10 5
	update_biomass_recipe("biomass-b-molasse", nil, "b-molasse", nil, "biomass", nil) -- 3 b-molasse 10 12
	update_biomass_recipe("biomass-casein-mixture", nil, "casein-mixture", nil, "biomass", nil) -- 3 casein-mixture 10 7
	update_biomass_recipe("biomass-casein-pulp-01", nil, "casein-pulp-01", nil, "biomass", nil) -- 3 casein-pulp-01 10 8
	update_biomass_recipe("biomass-casein-pulp-02", nil, "casein-pulp-02", nil, "biomass", nil) -- 3 casein-pulp-02 10 9
	...
	update_biomass_recipe("biomass-milk", nil, "milk", nil, "biomass", nil) -- 3 milk 10 5
	update_biomass_recipe("biomass-psc", nil, "psc", nil, "biomass", nil) -- 3 psc 5 5
	update_biomass_recipe("biomass-sweet-syrup", nil, "sweet-syrup", nil, "biomass", nil) -- 3 sweet-syrup 10 8
	update_biomass_recipe("biomass-syrup-01", nil, "syrup-01", nil, "biomass", nil) -- 3 syrup-01 10 7
	update_biomass_recipe("biomass-xenogenic-cells", nil, "xenogenic-cells", nil, "biomass", nil) -- 3 xenogenic-cells 5 4
	update_biomass_recipe("biomass-liquid-manure", nil, "liquid-manure", nil, "biomass", nil) -- 3 liquid-manure 10 5
	update_biomass_recipe("biomass-black-liquor", nil, "black-liquor", nil, "biomass", nil) -- 3 black-liquor 10 10
	update_biomass_recipe("biomass-tall-oil", nil, "tall-oil", 20, "biomass", 1) -- 3 tall-oil 10 8
	update_biomass_recipe("biomass-raw-ralesia-extract", nil, "raw-ralesia-extract", nil, "biomass", nil) -- 3 raw-ralesia-extract 10 5
	update_biomass_recipe("biomass-ralesia-extract", nil, "ralesia-extract", nil, "biomass", nil) -- 3 ralesia-extract 10 5
	update_biomass_recipe("biomass-condensates", nil, "condensates", 20, "biomass", 1) -- 3 condensates 10 4
	update_biomass_recipe("biomass-condensed-distillate", nil, "condensed-distillate", 20, "biomass", 1) -- 3 condensed-distillate 10 4
	update_biomass_recipe("biomass-naphtha", nil, "naphtha", 20, "biomass", 1) -- 3 naphtha 10 5
	update_biomass_recipe("biomass-scrude", nil, "scrude", 20, "biomass", 1) -- 3 scrude 10 3
end
